...
ACHIEVEMENTS: tuple[Achievement, ...] = (
    ...
    Achievement("clean-account", "goody two-shoes", "returned 10 rentals with zero late fees.", "return 10 rentals with zero late fees.", "rentals", 10, _on_time_count, "🧾"),
    Achievement("late-fee-legend", "late fee legend", "racked up $10 in late fees.", "rack up $10 in late fees.", "rentals", 10, _late_fee_total, "💸"),
    Achievement("last-minute-save", "buzzer beater", "returned a rental on its due date.", "return a rental on its due date.", "rentals", 1, _due_day_return_count, "⏳"),
    ...
    Achievement("time-traveler", "flux capacitor", "returned rentals from 7 different decades.", "return rentals from 7 different decades.", "rentals", 7, _decades_returned_count, "🗓️"),
    Achievement("range", "omnivore", "returned rentals across 6 era buckets.", "return rentals from pre-1980, the 1980s, 1990s, 2000s, 2010s, and 2020s.", "rentals", 6, _range_count, "🌈"),
    ...
    Achievement("cage", "national treasure", "returned 5 Nicolas Cage rentals.", "return 5 Nicolas Cage movies from rb9.", "rb9 library", 5, _metadata_count("actors", "Nicolas Cage"), "🐝"),
    ...
    Achievement("matrix", "human battery", "returned 3 Matrix rentals.", "return 3 Matrix movies from rb9.", "rb9 library", 3, _title_contains_any_count(("matrix",)), "🕶️"),
    ...
    Achievement("night", "creature of the night", "returned 5 rentals with night in the title.", "return 5 rb9 movies with night in the title.", "rb9 library", 5, _title_word_count("night"), "🌙"),
    Achievement("evil", "evil little guy", "returned 3 rentals with evil in the title.", "return 3 rb9 movies with evil in the title.", "rb9 library", 3, _title_word_count("evil"), "😈"),
    ...
    Achievement("tokyo-drifter", "tokyo drifter", "returned 5 Japanese rentals.", "return 5 rb9 movies from Japan.", "rb9 library", 5, _metadata_count("countries", "Japan"), "⛩️"),
    ...
    Achievement("why-so-serious", "pencil magician", "returned a rental with Heath Ledger.", "return a movie with Heath Ledger in it.", "rb9 library", 1, _metadata_count("actors", "Heath Ledger"), "🃏"),
    ...
    Achievement("easy-recommend", "hype machine", "recommended 25 returned rentals.", "recommend 25 rentals when returning them.", "reviews", 25, _recommended_count, "❤️"),
    Achievement("not-for-me", "tough crowd", "marked 5 rentals as not recommended.", "mark 5 rentals as not recommended.", "reviews", 5, _not_recommended_count, "🚫"),
    Achievement("balanced-taste", "even steven", "recommended at least 5 rentals and rejected at least 5.", "recommend 5 rentals and mark 5 as not recommended.", "reviews", 5, _balanced_taste_count, "⚖️"),
    ...
    Achievement("taste-has-spoken", "serial perfectionist", "gave three rentals a 10/10.", "give three returned rentals a 10/10.", "reviews", 3, _perfect_rating_count, "💯"),
    ...
    Achievement("film-critic", "professional yapper", "left written thoughts on 25 returned rentals.", "leave thoughts on 25 rental returns.", "reviews", 25, _written_review_count, "📝"),
    Achievement("essayist", "long winded", "left a long written rental review.", "leave thoughts over 500 characters on a rental return.", "reviews", 1, _long_thought_count, "✍️"),
    ...
    Achievement("prop-collector", "storage unit", "owned 15 macguffins.", "own 15 macguffins.", "macguffins", 15, _macguffin_count, "🧳"),
    ...
    *MACGUFFIN_SET_ACHIEVEMENTS,
    ...
    Achievement("poster-child-ii", "the projectionist", "won 25 guess/trivia rounds.", "win 25 /guess or /play rounds.", "games", 25, _guess_wins, "🎬"),
    ...
    Achievement("connected-universe", "conspiracy board", "won 10 six degrees rounds.", "win 10 /six rounds.", "games", 10, _six_wins, "🕸️"),
    ...
    Achievement("fresh-start", "spring cleaning", "removed 10 films from your watchlist.", "remove 10 films from your watchlist.", "discovery", 10, _event_count("watchlist_remove"), "🧹"),
    Achievement("watchlist-importer", "baggage handler", "imported a Letterboxd watchlist.", "import a Letterboxd watchlist.", "discovery", 1, _letterboxd_watchlist_count, "📚"),
